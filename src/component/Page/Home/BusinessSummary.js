    ...
    <div className="flex flex-col mt-20 text-center ">
      ...
      <div class="stats shadow">
        <div class="stat">
          ...
          <div class="stat-desc text-purple-400">21% more than last month</div>
        </div>
        ...
        <div class="stat">
          ...
          <div class="stat-desc text-green-400">21% more than last month</div>
        </div>

        <div class="stat">
          <div class="stat-figure text-secondary"></div>
          <div class="stat-value">86%</div>
          <div class="stat-title">Client love it</div>
